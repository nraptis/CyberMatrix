...
@interface Test_Full_TriadH : XCTestCase

@end

@implementation Test_Full_TriadH

- (void)testFull_TriadH_2x2 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_TriadH_2x2();
...
- (void)testFull_TriadH_EachQuad_2x2 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_TriadH_EachQuad_2x2();
...
- (void)testFull_TriadH_EachMini_2x2 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_TriadH_EachMini_2x2();
