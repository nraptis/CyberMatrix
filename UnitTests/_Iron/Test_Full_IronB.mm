...
- (void)testFull_IronB_4x4 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_IronB_4x4();

    const M aExpected = {
        { 52, 53, 34, 35, 54, 55, 36, 37 },
        { 60, 61, 42, 43, 62, 63, 44, 45 },
        { 20, 21,  2,  3, 18, 19,  0,  1 },
        { 28, 29, 10, 11, 26, 27,  8,  9 },
        { 48, 49, 38, 39, 50, 51, 32, 33 },
        { 56, 57, 46, 47, 58, 59, 40, 41 },
        { 16, 17,  6,  7, 22, 23,  4,  5 },
        { 24, 25, 14, 15, 30, 31, 12, 13 }
    };
