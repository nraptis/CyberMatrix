...
- (void)testFull_IronD_4x4 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_IronD_4x4();

    const M aExpected = {
        {  4,  5, 22, 23,  6,  7, 16, 17 },
        { 12, 13, 30, 31, 14, 15, 24, 25 },
        { 32, 33, 50, 51, 38, 39, 48, 49 },
        { 40, 41, 58, 59, 46, 47, 56, 57 },
        {  0,  1, 18, 19,  2,  3, 20, 21 },
        {  8,  9, 26, 27, 10, 11, 28, 29 },
        { 36, 37, 54, 55, 34, 35, 52, 53 },
        { 44, 45, 62, 63, 42, 43, 60, 61 }
    };
