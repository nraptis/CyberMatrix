...
- (void)testFull_WizardB_4x4 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_WizardB_4x4();

    const M aExpected = {
        {  0,  1, 16, 17, 38, 39,  4,  5 },
        {  8,  9, 24, 25, 46, 47, 12, 13 },
        { 18, 19, 48, 49,  6,  7, 22, 23 },
        { 26, 27, 56, 57, 14, 15, 30, 31 },
        {  2,  3, 32, 33, 36, 37, 52, 53 },
        { 10, 11, 40, 41, 44, 45, 60, 61 },
        { 34, 35, 50, 51, 54, 55, 20, 21 },
        { 42, 43, 58, 59, 62, 63, 28, 29 }
    };
