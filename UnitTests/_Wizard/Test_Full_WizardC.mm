...
- (void)testFull_WizardC_4x4 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_WizardC_4x4();

    const M aExpected = {
        { 16, 17,  2,  3, 22, 23, 18, 19 },
        { 24, 25, 10, 11, 30, 31, 26, 27 },
        {  4,  5,  0,  1, 20, 21,  6,  7 },
        { 12, 13,  8,  9, 28, 29, 14, 15 },
        { 50, 51, 54, 55, 52, 53, 38, 39 },
        { 58, 59, 62, 63, 60, 61, 46, 47 },
        { 48, 49, 34, 35, 32, 33, 36, 37 },
        { 56, 57, 42, 43, 40, 41, 44, 45 }
    };
