...
- (void)testFull_WizardA_4x4 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_WizardA_4x4();

    const M aExpected = {
        { 16, 17, 50, 51,  4,  5, 20, 21 },
        { 24, 25, 58, 59, 12, 13, 28, 29 },
        {  2,  3, 18, 19, 36, 37,  6,  7 },
        { 10, 11, 26, 27, 44, 45, 14, 15 },
        { 32, 33, 48, 49, 52, 53, 22, 23 },
        { 40, 41, 56, 57, 60, 61, 30, 31 },
        {  0,  1, 34, 35, 38, 39, 54, 55 },
        {  8,  9, 42, 43, 46, 47, 62, 63 }
    };
