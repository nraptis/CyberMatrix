...
- (void)testFull_GoldD_4x4 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_GoldD_4x4();

    const M aExpected = {
        { 48, 49,  0,  1, 34, 35, 50, 51 },
        { 56, 57,  8,  9, 42, 43, 58, 59 },
        { 20, 21, 36, 37,  2,  3, 18, 19 },
        { 28, 29, 44, 45, 10, 11, 26, 27 },
        { 52, 53,  4,  5, 38, 39, 54, 55 },
        { 60, 61, 12, 13, 46, 47, 62, 63 },
        { 16, 17, 32, 33,  6,  7, 22, 23 },
        { 24, 25, 40, 41, 14, 15, 30, 31 }
    };
