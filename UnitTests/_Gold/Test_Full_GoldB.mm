...
- (void)testFull_GoldB_4x4 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_GoldB_4x4();

    const M aExpected = {
        { 22, 23,  6,  7, 32, 33, 16, 17 },
        { 30, 31, 14, 15, 40, 41, 24, 25 },
        { 54, 55, 38, 39,  4,  5, 52, 53 },
        { 62, 63, 46, 47, 12, 13, 60, 61 },
        { 18, 19,  2,  3, 36, 37, 20, 21 },
        { 26, 27, 10, 11, 44, 45, 28, 29 },
        { 50, 51, 34, 35,  0,  1, 48, 49 },
        { 58, 59, 42, 43,  8,  9, 56, 57 }
    };
