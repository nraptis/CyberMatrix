...
- (void)testFull_TorranceD_4x4 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_TorranceD_4x4();

    const M aExpected = {
        { 36, 37, 32, 33, 22, 23, 18, 19 },
        { 44, 45, 40, 41, 30, 31, 26, 27 },
        { 48, 49, 34, 35,  2,  3, 16, 17 },
        { 56, 57, 42, 43, 10, 11, 24, 25 },
        { 50, 51, 54, 55,  0,  1,  4,  5 },
        { 58, 59, 62, 63,  8,  9, 12, 13 },
        { 38, 39, 52, 53, 20, 21,  6,  7 },
        { 46, 47, 60, 61, 28, 29, 14, 15 }
    };
