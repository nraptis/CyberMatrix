...
- (void)testFull_BrassA_4x4 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_BrassA_4x4();

    const M aExpected = {
        { 18, 19, 54, 55, 22, 23, 50, 51 },
        { 26, 27, 62, 63, 30, 31, 58, 59 },
        {  4,  5, 32, 33,  0,  1, 36, 37 },
        { 12, 13, 40, 41,  8,  9, 44, 45 },
        { 20, 21, 52, 53, 16, 17, 48, 49 },
        { 28, 29, 60, 61, 24, 25, 56, 57 },
        {  6,  7, 38, 39,  2,  3, 34, 35 },
