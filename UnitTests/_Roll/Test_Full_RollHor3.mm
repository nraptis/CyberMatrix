...
@interface Test_Full_RollHor3 : XCTestCase

@end

@implementation Test_Full_RollHor3

- (void)testFull_RollHor3_4x4 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_RollHor3_4x4();
...
- (void)testFull_RollHor3_EachQuad_4x4 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_RollHor3_EachQuad_4x4();
