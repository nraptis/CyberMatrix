...
- (void)testFull_GooseD_4x4 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_GooseD_4x4();

    const M aExpected = {
        { 32, 33, 48, 49,  0,  1, 16, 17 },
        { 40, 41, 56, 57,  8,  9, 24, 25 },
        { 38, 39, 54, 55,  6,  7, 22, 23 },
        { 46, 47, 62, 63, 14, 15, 30, 31 },
        { 36, 37, 52, 53,  4,  5, 20, 21 },
        { 44, 45, 60, 61, 12, 13, 28, 29 },
        { 34, 35, 50, 51,  2,  3, 18, 19 },
        { 42, 43, 58, 59, 10, 11, 26, 27 }
    };
