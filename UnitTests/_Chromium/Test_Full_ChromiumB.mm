...
- (void)testFull_ChromiumB_4x4 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_ChromiumB_4x4();

    const M aExpected = {
        { 18, 19, 34, 35,  0,  1, 16, 17 },
        { 26, 27, 42, 43,  8,  9, 24, 25 },
        { 50, 51,  2,  3, 32, 33, 48, 49 },
        { 58, 59, 10, 11, 40, 41, 56, 57 },
        { 22, 23, 38, 39,  4,  5, 20, 21 },
        { 30, 31, 46, 47, 12, 13, 28, 29 },
        { 54, 55,  6,  7, 36, 37, 52, 53 },
        { 62, 63, 14, 15, 44, 45, 60, 61 }
    };
