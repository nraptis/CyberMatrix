...
- (void)testFull_SteelB_4x4 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_SteelB_4x4();

    const M aExpected = {
        { 50, 51, 36, 37, 52, 53, 38, 39 },
        { 58, 59, 44, 45, 60, 61, 46, 47 },
        { 18, 19,  4,  5, 16, 17,  2,  3 },
        { 26, 27, 12, 13, 24, 25, 10, 11 },
        { 54, 55, 32, 33, 48, 49, 34, 35 },
        { 62, 63, 40, 41, 56, 57, 42, 43 },
        { 22, 23,  0,  1, 20, 21,  6,  7 },
        { 30, 31,  8,  9, 28, 29, 14, 15 }
    };
