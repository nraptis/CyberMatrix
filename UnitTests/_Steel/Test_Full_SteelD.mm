...
- (void)testFull_SteelD_4x4 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_SteelD_4x4();

    const M aExpected = {
        {  6,  7, 20, 21,  0,  1, 22, 23 },
        { 14, 15, 28, 29,  8,  9, 30, 31 },
        { 34, 35, 48, 49, 32, 33, 54, 55 },
        { 42, 43, 56, 57, 40, 41, 62, 63 },
        {  2,  3, 16, 17,  4,  5, 18, 19 },
        { 10, 11, 24, 25, 12, 13, 26, 27 },
        { 38, 39, 52, 53, 36, 37, 50, 51 },
        { 46, 47, 60, 61, 44, 45, 58, 59 }
    };
