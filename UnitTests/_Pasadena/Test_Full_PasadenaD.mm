...
- (void)testFull_PasadenaD_4x4 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_PasadenaD_4x4();

    const M aExpected = {
        {  2,  3, 34, 35, 20, 21, 52, 53 },
        { 10, 11, 42, 43, 28, 29, 60, 61 },
        { 32, 33, 50, 51, 54, 55, 36, 37 },
        { 40, 41, 58, 59, 62, 63, 44, 45 },
        { 48, 49, 16, 17, 38, 39,  6,  7 },
        { 56, 57, 24, 25, 46, 47, 14, 15 },
        { 18, 19,  0,  1,  4,  5, 22, 23 },
        { 26, 27,  8,  9, 12, 13, 30, 31 }
    };
