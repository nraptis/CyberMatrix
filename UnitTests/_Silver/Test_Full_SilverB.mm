...
- (void)testFull_SilverB_4x4 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_SilverB_4x4();

    const M aExpected = {
        { 38, 39, 22, 23, 16, 17,  0,  1 },
        { 46, 47, 30, 31, 24, 25,  8,  9 },
        {  6,  7, 54, 55, 52, 53, 36, 37 },
        { 14, 15, 62, 63, 60, 61, 44, 45 },
        { 34, 35, 18, 19, 20, 21,  4,  5 },
        { 42, 43, 26, 27, 28, 29, 12, 13 },
        {  2,  3, 50, 51, 48, 49, 32, 33 },
        { 10, 11, 58, 59, 56, 57, 40, 41 }
    };
