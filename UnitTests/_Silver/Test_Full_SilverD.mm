...
- (void)testFull_SilverD_4x4 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_SilverD_4x4();

    const M aExpected = {
        { 32, 33, 48, 49, 50, 51,  2,  3 },
        { 40, 41, 56, 57, 58, 59, 10, 11 },
        {  4,  5, 20, 21, 18, 19, 34, 35 },
        { 12, 13, 28, 29, 26, 27, 42, 43 },
        { 36, 37, 52, 53, 54, 55,  6,  7 },
        { 44, 45, 60, 61, 62, 63, 14, 15 },
        {  0,  1, 16, 17, 22, 23, 38, 39 },
        {  8,  9, 24, 25, 30, 31, 46, 47 }
    };
