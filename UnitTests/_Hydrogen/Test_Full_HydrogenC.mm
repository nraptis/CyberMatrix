...
@interface Test_Full_HydrogenC : XCTestCase

@end

@implementation Test_Full_HydrogenC

- (void)testFull_HydrogenC_4x4 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_HydrogenC_4x4();
...
- (void)testFull_HydrogenC_EachQuad_4x4 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_HydrogenC_EachQuad_4x4();
...
- (void)testFull_HydrogenC_8x8 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_HydrogenC_8x8();
