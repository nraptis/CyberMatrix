...
@interface Test_Full_BurbankB : XCTestCase

@end

@implementation Test_Full_BurbankB

- (void)testFull_BurbankB_4x4 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_BurbankB_4x4();
...
- (void)testFull_BurbankB_EachQuad_4x4 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_BurbankB_EachQuad_4x4();
...
- (void)testFull_BurbankB_8x8 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_BurbankB_8x8();
