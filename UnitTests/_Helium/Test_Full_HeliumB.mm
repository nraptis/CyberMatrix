...
@interface Test_Full_HeliumB : XCTestCase

@end

@implementation Test_Full_HeliumB

- (void)testFull_HeliumB_4x4 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_HeliumB_4x4();
...
- (void)testFull_HeliumB_EachQuad_4x4 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_HeliumB_EachQuad_4x4();
...
- (void)testFull_HeliumB_8x8 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_HeliumB_8x8();
