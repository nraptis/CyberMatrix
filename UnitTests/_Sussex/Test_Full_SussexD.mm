...
- (void)testFull_SussexD_4x4 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_SussexD_4x4();

    const M aExpected = {
        { 38, 39,  2,  3, 22, 23, 50, 51 },
        { 46, 47, 10, 11, 30, 31, 58, 59 },
        { 52, 53, 16, 17,  0,  1, 36, 37 },
        { 60, 61, 24, 25,  8,  9, 44, 45 },
        { 32, 33, 48, 49, 20, 21,  4,  5 },
        { 40, 41, 56, 57, 28, 29, 12, 13 },
        { 54, 55, 34, 35,  6,  7, 18, 19 },
        { 62, 63, 42, 43, 14, 15, 26, 27 }
    };
