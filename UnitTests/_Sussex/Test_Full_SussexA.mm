...
- (void)testFull_SussexA_4x4 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_SussexA_4x4();

    const M aExpected = {
        {  4,  5, 32, 33, 48, 49, 20, 21 },
        { 12, 13, 40, 41, 56, 57, 28, 29 },
        { 18, 19, 54, 55, 34, 35,  6,  7 },
        { 26, 27, 62, 63, 42, 43, 14, 15 },
        { 50, 51, 38, 39,  2,  3, 22, 23 },
        { 58, 59, 46, 47, 10, 11, 30, 31 },
        { 36, 37, 52, 53, 16, 17,  0,  1 },
        { 44, 45, 60, 61, 24, 25,  8,  9 }
    };
