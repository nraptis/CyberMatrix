...
- (void)testFull_UmbriaB_4x4 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_UmbriaB_4x4();

    const M aExpected = {
        { 54, 55, 48, 49, 20, 21, 18, 19 },
        { 62, 63, 56, 57, 28, 29, 26, 27 },
        {  6,  7, 32, 33,  4,  5, 34, 35 },
        { 14, 15, 40, 41, 12, 13, 42, 43 },
        { 38, 39,  2,  3, 36, 37,  0,  1 },
        { 46, 47, 10, 11, 44, 45,  8,  9 },
        { 22, 23, 50, 51, 52, 53, 16, 17 },
        { 30, 31, 58, 59, 60, 61, 24, 25 }
    };
