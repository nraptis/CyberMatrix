...
- (void)testFull_UmbriaD_4x4 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_UmbriaD_4x4();

    const M aExpected = {
        { 54, 55, 18, 19, 20, 21, 48, 49 },
        { 62, 63, 26, 27, 28, 29, 56, 57 },
        {  6,  7, 34, 35,  4,  5, 32, 33 },
        { 14, 15, 42, 43, 12, 13, 40, 41 },
        { 36, 37,  2,  3, 38, 39,  0,  1 },
        { 44, 45, 10, 11, 46, 47,  8,  9 },
        { 52, 53, 50, 51, 22, 23, 16, 17 },
        { 60, 61, 58, 59, 30, 31, 24, 25 }
    };
