...
- (void)testFull_PalladiumD_4x4 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_PalladiumD_4x4();

    const M aExpected = {
        { 18, 19,  0,  1, 20, 21,  2,  3 },
        { 26, 27,  8,  9, 28, 29, 10, 11 },
        { 50, 51, 32, 33, 52, 53, 34, 35 },
        { 58, 59, 40, 41, 60, 61, 42, 43 },
        { 22, 23,  4,  5, 16, 17,  6,  7 },
        { 30, 31, 12, 13, 24, 25, 14, 15 },
        { 54, 55, 36, 37, 48, 49, 38, 39 },
        { 62, 63, 44, 45, 56, 57, 46, 47 }
    };
