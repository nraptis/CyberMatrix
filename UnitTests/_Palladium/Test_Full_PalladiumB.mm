...
- (void)testFull_PalladiumB_4x4 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_PalladiumB_4x4();

    const M aExpected = {
        { 38, 39, 48, 49, 36, 37, 54, 55 },
        { 46, 47, 56, 57, 44, 45, 62, 63 },
        {  6,  7, 16, 17,  4,  5, 22, 23 },
        { 14, 15, 24, 25, 12, 13, 30, 31 },
        { 34, 35, 52, 53, 32, 33, 50, 51 },
        { 42, 43, 60, 61, 40, 41, 58, 59 },
        {  2,  3, 20, 21,  0,  1, 18, 19 },
        { 10, 11, 28, 29,  8,  9, 26, 27 }
    };
