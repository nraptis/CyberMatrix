...
@interface Test_Full_OsakaC : XCTestCase

@end

@implementation Test_Full_OsakaC

- (void)testFull_OsakaC_4x4 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_OsakaC_4x4();
...
- (void)testFull_OsakaC_EachQuad_4x4 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_OsakaC_EachQuad_4x4();
...
- (void)testFull_OsakaC_8x8 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_OsakaC_8x8();
