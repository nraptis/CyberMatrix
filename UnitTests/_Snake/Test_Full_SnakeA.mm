...
@interface Test_Full_SnakeA : XCTestCase

@end

@implementation Test_Full_SnakeA

- (void)testFull_SnakeA_2x2 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_SnakeA_2x2();

    const M aExpected = {
        {  4,  5,  6,  7, 32, 33, 34, 35 },
        { 12, 13, 14, 15, 40, 41, 42, 43 },
        { 20, 21, 22, 23, 48, 49, 50, 51 },
        { 28, 29, 30, 31, 56, 57, 58, 59 },
        { 36, 37, 38, 39,  0,  1,  2,  3 },
        { 44, 45, 46, 47,  8,  9, 10, 11 },
        { 52, 53, 54, 55, 16, 17, 18, 19 },
...
- (void)testFull_SnakeA_EachQuad_2x2 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_SnakeA_EachQuad_2x2();
...
- (void)testFull_SnakeA_EachMini_2x2 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_SnakeA_EachMini_2x2();
