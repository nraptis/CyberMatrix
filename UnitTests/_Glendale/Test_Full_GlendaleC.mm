...
- (void)testFull_GlendaleC_4x4 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_GlendaleC_4x4();

    const M aExpected = {
        { 18, 19,  6,  7,  4,  5, 16, 17 },
        { 26, 27, 14, 15, 12, 13, 24, 25 },
        { 22, 23, 20, 21,  0,  1,  2,  3 },
        { 30, 31, 28, 29,  8,  9, 10, 11 },
        { 32, 33, 52, 53, 54, 55, 34, 35 },
        { 40, 41, 60, 61, 62, 63, 42, 43 },
        { 36, 37, 38, 39, 50, 51, 48, 49 },
        { 44, 45, 46, 47, 58, 59, 56, 57 }
    };
