...
- (void)testFull_BronzeB_4x4 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_BronzeB_4x4();

    const M aExpected = {
        {  4,  5, 22, 23,  2,  3, 20, 21 },
        { 12, 13, 30, 31, 10, 11, 28, 29 },
        { 36, 37, 54, 55, 38, 39, 48, 49 },
        { 44, 45, 62, 63, 46, 47, 56, 57 },
        {  0,  1, 18, 19,  6,  7, 16, 17 },
        {  8,  9, 26, 27, 14, 15, 24, 25 },
        { 32, 33, 50, 51, 34, 35, 52, 53 },
        { 40, 41, 58, 59, 42, 43, 60, 61 }
    };
