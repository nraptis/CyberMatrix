...
- (void)testFull_NagoyaD_4x4 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_NagoyaD_4x4();

    const M aExpected = {
        { 38, 39, 32, 33,  0,  1,  6,  7 },
        { 46, 47, 40, 41,  8,  9, 14, 15 },
        { 54, 55, 50, 51, 20, 21, 16, 17 },
        { 62, 63, 58, 59, 28, 29, 24, 25 },
        { 36, 37, 34, 35,  2,  3,  4,  5 },
        { 44, 45, 42, 43, 10, 11, 12, 13 },
        { 48, 49, 52, 53, 18, 19, 22, 23 },
        { 56, 57, 60, 61, 26, 27, 30, 31 }
    };
