...
- (void)testFull_NagoyaC_4x4 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_NagoyaC_4x4();

    const M aExpected = {
        { 48, 49, 50, 51, 18, 19, 16, 17 },
        { 56, 57, 58, 59, 26, 27, 24, 25 },
        { 38, 39, 34, 35,  0,  1,  4,  5 },
        { 46, 47, 42, 43,  8,  9, 12, 13 },
        { 54, 55, 52, 53, 20, 21, 22, 23 },
        { 62, 63, 60, 61, 28, 29, 30, 31 },
        { 36, 37, 32, 33,  2,  3,  6,  7 },
        { 44, 45, 40, 41, 10, 11, 14, 15 }
    };
