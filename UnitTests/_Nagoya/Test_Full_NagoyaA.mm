...
- (void)testFull_NagoyaA_4x4 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_NagoyaA_4x4();

    const M aExpected = {
        { 20, 21,  4,  5, 54, 55, 34, 35 },
        { 28, 29, 12, 13, 62, 63, 42, 43 },
        { 22, 23, 36, 37, 52, 53,  2,  3 },
        { 30, 31, 44, 45, 60, 61, 10, 11 },
        { 18, 19,  6,  7, 48, 49, 32, 33 },
        { 26, 27, 14, 15, 56, 57, 40, 41 },
        { 16, 17, 38, 39, 50, 51,  0,  1 },
        { 24, 25, 46, 47, 58, 59,  8,  9 }
    };
