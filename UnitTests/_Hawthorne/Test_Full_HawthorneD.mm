...
- (void)testFull_HawthorneD_4x4 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_HawthorneD_4x4();

    const M aExpected = {
        {  6,  7, 18, 19, 16, 17,  4,  5 },
        { 14, 15, 26, 27, 24, 25, 12, 13 },
        {  2,  3,  0,  1, 20, 21, 22, 23 },
        { 10, 11,  8,  9, 28, 29, 30, 31 },
        { 52, 53, 32, 33, 34, 35, 54, 55 },
        { 60, 61, 40, 41, 42, 43, 62, 63 },
        { 48, 49, 50, 51, 38, 39, 36, 37 },
        { 56, 57, 58, 59, 46, 47, 44, 45 }
    };
