...
@interface Test_Full_YorkB : XCTestCase

@end

@implementation Test_Full_YorkB

- (void)testFull_YorkB_4x4 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_YorkB_4x4();
...
- (void)testFull_YorkB_EachQuad_4x4 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_YorkB_EachQuad_4x4();
...
- (void)testFull_YorkB_8x8 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_YorkB_8x8();
