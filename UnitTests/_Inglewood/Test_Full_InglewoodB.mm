...
- (void)testFull_InglewoodB_4x4 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_InglewoodB_4x4();

    const M aExpected = {
        { 18, 19, 32, 33, 34, 35, 48, 49 },
        { 26, 27, 40, 41, 42, 43, 56, 57 },
        {  2,  3,  0,  1, 50, 51, 16, 17 },
        { 10, 11,  8,  9, 58, 59, 24, 25 },
        {  6,  7, 20, 21, 54, 55,  4,  5 },
        { 14, 15, 28, 29, 62, 63, 12, 13 },
        { 22, 23, 52, 53, 38, 39, 36, 37 },
        { 30, 31, 60, 61, 46, 47, 44, 45 }
    };
