...
- (void)testFull_InglewoodA_4x4 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_InglewoodA_4x4();

    const M aExpected = {
        { 32, 33, 34, 35, 48, 49, 18, 19 },
        { 40, 41, 42, 43, 56, 57, 26, 27 },
        { 16, 17,  2,  3,  0,  1, 50, 51 },
        { 24, 25, 10, 11,  8,  9, 58, 59 },
        { 20, 21, 54, 55,  4,  5,  6,  7 },
        { 28, 29, 62, 63, 12, 13, 14, 15 },
        { 36, 37, 22, 23, 52, 53, 38, 39 },
        { 44, 45, 30, 31, 60, 61, 46, 47 }
    };
