...
- (void)testFull_PlatinumD_4x4 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_PlatinumD_4x4();

    const M aExpected = {
        { 32, 33, 54, 55, 38, 39, 52, 53 },
        { 40, 41, 62, 63, 46, 47, 60, 61 },
        {  0,  1, 22, 23,  6,  7, 20, 21 },
        {  8,  9, 30, 31, 14, 15, 28, 29 },
        { 36, 37, 50, 51, 34, 35, 48, 49 },
        { 44, 45, 58, 59, 42, 43, 56, 57 },
        {  4,  5, 18, 19,  2,  3, 16, 17 },
        { 12, 13, 26, 27, 10, 11, 24, 25 }
    };
