...
- (void)testFull_PlatinumB_4x4 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_PlatinumB_4x4();

    const M aExpected = {
        { 16, 17,  2,  3, 18, 19,  4,  5 },
        { 24, 25, 10, 11, 26, 27, 12, 13 },
        { 48, 49, 34, 35, 50, 51, 36, 37 },
        { 56, 57, 42, 43, 58, 59, 44, 45 },
        { 20, 21,  6,  7, 22, 23,  0,  1 },
        { 28, 29, 14, 15, 30, 31,  8,  9 },
        { 52, 53, 38, 39, 54, 55, 32, 33 },
        { 60, 61, 46, 47, 62, 63, 40, 41 }
    };
