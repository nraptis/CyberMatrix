...
- (void)testFull_ZirconiumB_4x4 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_ZirconiumB_4x4();

    const M aExpected = {
        {  2,  3, 18, 19, 16, 17, 32, 33 },
        { 10, 11, 26, 27, 24, 25, 40, 41 },
        { 34, 35, 50, 51, 48, 49,  0,  1 },
        { 42, 43, 58, 59, 56, 57,  8,  9 },
        {  6,  7, 22, 23, 20, 21, 36, 37 },
        { 14, 15, 30, 31, 28, 29, 44, 45 },
        { 38, 39, 54, 55, 52, 53,  4,  5 },
        { 46, 47, 62, 63, 60, 61, 12, 13 }
    };
