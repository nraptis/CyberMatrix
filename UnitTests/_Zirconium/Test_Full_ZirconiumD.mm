...
- (void)testFull_ZirconiumD_4x4 {
    M88 aBefore = VerifyFull::SpawnTestMatrixFull();
    M88 aAfter = aBefore;

    aAfter.Full_ZirconiumD_4x4();

    const M aExpected = {
        {  4,  5, 52, 53, 54, 55, 38, 39 },
        { 12, 13, 60, 61, 62, 63, 46, 47 },
        { 36, 37, 20, 21, 22, 23,  6,  7 },
        { 44, 45, 28, 29, 30, 31, 14, 15 },
        {  0,  1, 48, 49, 50, 51, 34, 35 },
        {  8,  9, 56, 57, 58, 59, 42, 43 },
        { 32, 33, 16, 17, 18, 19,  2,  3 },
        { 40, 41, 24, 25, 26, 27, 10, 11 }
    };
